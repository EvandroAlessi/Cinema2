...
//            }
            if (ok) {
                ...
                if (sessaoCriada == null) {
                    ...
                    try {
                        ...
                        nSessao.setSalaID(cbSala.getSelectionModel().getSelectedItem().getSalaID());
                        nSessao.setFilmeID(cbFilme.getSelectionModel().getSelectedItem().getFilmeID());
    ...
    public void start(Stage mainStage, Sessao sessao) throws Exception {
        dialog = new Stage();
        GridPane painel = criarFormulario(sessao);
    ...
    private GridPane criarFormulario(Sessao sessao) {
